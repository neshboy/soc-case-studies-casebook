...
if __name__ == "__main__":
    in_path = sys.argv[1] if len(sys.argv) > 1 else r"C:\Users\User\projects\soc-case-studies-casebook\_build\SOC_Case_Studies_Casebook.pdf"
    out_path = sys.argv[2] if len(sys.argv) > 2 else r"C:\Users\User\projects\soc-case-studies-casebook\_build\SOC_Case_Studies_Casebook_watermarked.pdf"
